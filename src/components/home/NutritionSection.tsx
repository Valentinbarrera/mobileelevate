...
const NutritionSection = React.forwardRef<HTMLDivElement, NutritionSectionProps>(
  ({ targetKcal, currentPercent, protein, carbs, fat = { current: 65, target: 80 }, nextMeal }, ref) => {
