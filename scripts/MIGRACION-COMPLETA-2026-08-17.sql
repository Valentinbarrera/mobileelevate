-- ############################################################################
-- ELEVATE — MIGRACIÓN COMPLETA (17/08/2026)
-- ############################################################################
-- Pegar TODO esto en el SQL Editor de Supabase (proyecto gssgoeaupfssexhliazy)
-- y darle Run UNA sola vez. Es idempotente: si lo corrés de nuevo no rompe nada.
--
-- El editor corre todo dentro de UNA transacción: o entra todo, o no entra nada.
...
--
-- Qué desbloquea:
--   • WEB DEL COACH  → pestaña "Desde la app" con datos reales + módulo
...
-- ############################################################################
-- 3/7 · Evaluaciones / antropometría (evaluations + anthropometry_measurements + bucket)
...
-- ############################################################################
-- 6/7 · delete_my_account() actualizado (Apple 5.1.1v) — borra también lo nuevo
...
-- ############################################################################
-- LISTO. Para comprobar que entró todo, corré esto: tienen que salir 9 filas.
-- ############################################################################
